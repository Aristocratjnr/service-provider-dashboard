...
const topIssuesData = [
  {
    ...
    type: "Late delivery",
    count: 10,
    trend: { value: 5, direction: "up" as "up" },
  },
  {
    name: "Laundry",
    orders: 8,
    ...
    type: "High pricing",
    count: 15,
    trend: { value: 3, direction: "down" as "down" },
  },
  {
    name: "Ironing",
    orders: 3,
    ...
    type: "Missing Item",
    count: 2,
    trend: { value: 1, direction: "up" as "up" },
  },
];
...
export default function Dashboard() {
  return (
    <div
      ...
      style={{ background: "rgba(161, 222, 247, 0.10)" }}
    >
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-semi-bold text-2xl tracking-tight">
        ...
        <div className="relative">
          <select className="w-full appearance-none rounded-md border border-cyan-300 py-2 pl-8 pr-3 text-sm text-gray-500">
            <option className="text-gray-400">Filters</option>
            <option>Today</option>
            <option>This Week</option>
            <option>This Month</option>
          </select>
          <FilterIcon className="pointer-events-none absolute left-2 top-1/2 h-5 w-5 -translate-y-1/2 transform text-gray-600" />
        </div>
      </div>
